...
namespace Exercicio3.Models
{
      ...
      {
        public Boss(string nome, int vida, int mana, float xp, int inteligencia, int forca, int level) : base(nome, vida, mana, xp, inteligencia, forca, level)
        {
            Nome = nome;
            Vida = vida;
            Mana = mana;
        ...
        public override void lvlUp()
        {
            ...
            $"\n\n<STATUS DO PERSONGEM - BOSS FINAL>"+
        ...
        public override void attack ()
        {
            ...
            recebeRandom += (Forca + Inteligencia * Level)/2;
            WriteLine("\n==========================================================="+
